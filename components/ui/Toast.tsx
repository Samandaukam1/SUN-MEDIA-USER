...
// On iOS native modals (page sheets, form modals) sit above the React root; the overlay window keeps
// confirmations and errors visible over them. Touches outside the toast pass through.
...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  const api = useMemo<ToastApi>(
    () => ({ show, error: (e) => show(toUserMessage(e), "error") }),
    [show],
  );
  const icon: IconName =
    toast?.tone === "error"
